...
var DATA_TABLE_PROMPT = 'Use fenced `csv`, `tsv`, or `json-table` blocks for tabular data that should render as a table. For `json-table`, use either an array of flat objects or an object shaped as `{"columns":["Column"],"rows":[["Value"]]}`. Keep ordinary JSON in `json` fences so it remains code.';
